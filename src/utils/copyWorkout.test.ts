      ...
      const workout = createFeedWorkout({
        session_exercises: [
          createStrengthExercise({
            ...
            rest_seconds: null,
            completed_sets: [
              { id: 's1', type: 'strength', reps: 10, weight: 100, weight_unit: 'lbs', distance: null, distance_unit: null, calories: null, duration_seconds: null, completed_at: '' },
              { id: 's2', type: 'strength', reps: 10, weight: 100, weight_unit: 'lbs', distance: null, distance_unit: null, calories: null, duration_seconds: null, completed_at: '' },
            ],
          }),
        ],
      });
