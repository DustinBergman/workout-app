import { FC, DOMAttributes, useState, useRef, useEffect } from 'react';
...
export const ExerciseAccordion: FC<ExerciseAccordionProps> = ({
  ...
  const wrappedUpdateTargetSets = (delta: number) => updateTargetSets(index, delta);
        ...
        <div className="px-4 pb-4 border-t border-border/50 bg-white/15 dark:bg-white/8 backdrop-blur-lg">
          ...
          <div className="flex items-center gap-2 mt-3 pb-3 border-b border-border/50">
            <button
              ...
              className="py-1.5 px-3 text-sm rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors flex items-center gap-1.5"
            >
            ...
            <span className="flex-1 text-sm text-gray-600 dark:text-gray-400 text-right">
              {targetSets} sets
            </span>
            ...
            <div className="relative" ref={menuRef}>
              ...
              {showMenu && (
                <div className="absolute right-0 top-full mt-1 z-20 w-44 rounded-lg border border-border/60 bg-bg-2 shadow-lg overflow-hidden">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      setShowMenu(false);
                    ...
                    className="w-full px-3 py-2.5 text-sm text-left text-fg-2 hover:bg-bg-subtle transition-colors flex items-center gap-2"
                  >
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <button
                    ...
                    className="w-full px-3 py-2.5 text-sm text-left text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors flex items-center gap-2"
                  >
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
